...
export function FileViewer() {
  ...
  if (!viewingFile && !isLoadingFileContent) return null;
      ...
      <div className="flex flex-col w-full items-center overflow-y-auto">
        <div className="flex items-center justify-between w-full md:w-[500px] px-4 md:px-0 pt-20 pb-4 border-b border-gray-800">
          ...
          <button
            ...
            className="text-sm px-3 py-1 rounded-md bg-zinc-100 hover:bg-zinc-200 dark:bg-zinc-700 dark:hover:bg-zinc-600 text-zinc-600 dark:text-zinc-300 transition-colors flex-shrink-0 ml-4"
          >
            Close
          </button>
        </div>
